...
public final class Protocol {
    ...
    private static final String CORRUPTED_MESSAGE = "000"; // interní informace pro server
...
* @param message zprava od klienta
     ...
     * byt pouze souradnice znacky. Osetreni delky zpravy tak, aby byly
     * interpretovany jen ty validni
     *
     * @param message zprava od klienta
