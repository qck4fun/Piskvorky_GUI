...
/**
 * Protokol slouzici pro komunikaci mezi klienty a serverem pri hre piskvorek
 * 
 * @author michal
 * 
 */
public final class Protocol {
    ...
    public static final String NOT_YOUR_TURN = "614";       // informace o tom, ze rac neni na tahu
    ...
    public static final String OPPONENT_LEFT = "701";
    public static final String GENERAL_FAIL = "800";        // informace o tom, ze se na serveru stala chyba..

    private static final String CORRUPTED_MESSAGE = "000";
    
    private Protocol(){}

    /**
     * Vrati substring s cislem zpravy protokolu. Pro zpravy, ktere
     * neodpovidaji protokolu -> delkou kratsi nez tri vrati String, ktery
     * nebude souhlasit se zadny cislem protokolu. To je tak proto, aby pri
     * zaslani prazdne zpravy nenastala vyjimka pri volani metody substring
     * 
     * @param message
     *            zprava od klienta
    ...
    /**
     * Vrati substring s telem zpravy. To pri teto specifikaci protokolu mohou
     * byt pouze souradnice znacky. Osetreni delky zpravy tak, aby byly interpretovany
     * jen ty validni
     * @param message zprava od klienta
     * @return telo zpravy bez protokolu
     */
